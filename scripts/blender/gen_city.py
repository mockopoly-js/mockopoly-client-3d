...
# --------------------------------------------------------------------------- #
# Shared box primitive — canonical impl lives in lib.py; alias so the city
# builders keep calling the bare `add_box(...)` (shared with gen_tokens.py /
# gen_buildings.py via lib.add_box).
# --------------------------------------------------------------------------- #
