...
const CITY_Y = 0.20;          // must exceed TOP_Y + BOARD_DISPLACEMENT_SCALE (BoardTiles): 0.20 > 0.02 + 0.15 = 0.17, so the taller displaced board plane doesn't occlude the city base
